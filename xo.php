...
if (isset($_POST['editTeacher'])) {
    if(isset($_POST['id_edit'])) {
        ...
        $sql = "UPDATE teachers SET nip='$nip_edit', nama='$nama_edit', mata_pelajaran='$mata_pelajaran_edit' WHERE id='$id_edit'";
        $result = $conn->query($sql);
...
if (isset($_GET['deleteTeacher'])) {
    $id_delete = $_GET['deleteTeacher'];

    $sql = "DELETE FROM teachers WHERE id='$id_delete'";
    $result = $conn->query($sql);
...
if (isset($_POST['editStudent'])) {
    if(isset($_POST['id_edit'])) {
        ...
        $sql = "UPDATE students SET nisn='$nisn_edit', nama='$nama_siswa_edit', kelas='$kelas_edit' WHERE id='$id_edit'";
        $result = $conn->query($sql);
...
if (isset($_GET['deleteStudent'])) {
    $id_delete = $_GET['deleteStudent'];

    $sql = "DELETE FROM students WHERE id='$id_delete'";
    $result = $conn->query($sql);
    ...
    <style>
       body {
        ...
        header img {
            ...
            height: auto;
            margin-top: auto; /* Menambahkan margin ke bawah */
        }
...
.add-button:hover {
    background-color: rgb(129, 138, 0);
}
...
.event-item{
    ...
    .dashboard-item .add-button:hover {
        background-color: rgb(129, 138, 0);
    }
    </style>
</head>
<body>
    ...
    <div class="event-item">
        ...
        <img src="lol.jpg" alt="Event 1" style="float: left; margin-right: 20px; max-width: 300px;">
    </div>
    ...
    <div class="event-item">
        ...
        <img src="event2.jpg" alt="Event 2" style="float: left; margin-right: 20px; max-width: 300px;">
    </div>
    ...
    <div class="event-item">
        ...
        <img src="even.jpg" alt="Event 3" style="float: left; margin-right: 20px; max-width: 300px;">
    </div>
</section>
